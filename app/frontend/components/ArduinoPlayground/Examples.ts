...
void loop() {
  ...
  digitalWrite(11, LOW);
    ...
    circuitData: {
      ...
      wires: [
        // Red LED
        { id: 'wire_red_sig', fromComponent: 'arduino', fromPin: 'D13', toComponent: 'led_red', toPin: 'anode', color: '#ef4444' },
        { id: 'wire_red_gnd', fromComponent: 'arduino', fromPin: 'GND_D', toComponent: 'led_red', toPin: 'cathode', color: '#000000' },
        // Yellow LED
        { id: 'wire_yellow_sig', fromComponent: 'arduino', fromPin: 'D12', toComponent: 'led_yellow', toPin: 'anode', color: '#eab308' },
        { id: 'wire_yellow_gnd', fromComponent: 'arduino', fromPin: 'GND1', toComponent: 'led_yellow', toPin: 'cathode', color: '#6b7280' },
        // Green LED
        { id: 'wire_green_sig', fromComponent: 'arduino', fromPin: 'D11', toComponent: 'led_green', toPin: 'anode', color: '#22c55e' },
        { id: 'wire_green_gnd', fromComponent: 'arduino', fromPin: 'GND2', toComponent: 'led_green', toPin: 'cathode', color: '#374151' }
      ]
    }
  },
  {
...
void loop() {
  if (digitalRead(2) == LOW) {
    ...
    circuitData: {
      ...
      wires: [
        // LED wires
        { id: 'wire_led_sig', fromComponent: 'arduino', fromPin: 'D13', toComponent: 'led_1', toPin: 'anode', color: '#22c55e' },
        { id: 'wire_led_gnd', fromComponent: 'arduino', fromPin: 'GND_D', toComponent: 'led_1', toPin: 'cathode', color: '#000000' },
        // Button wires
        { id: 'wire_btn_sig', fromComponent: 'arduino', fromPin: 'D2', toComponent: 'button_1', toPin: 'terminal1a', color: '#3b82f6' },
        { id: 'wire_btn_gnd', fromComponent: 'arduino', fromPin: 'GND1', toComponent: 'button_1', toPin: 'terminal1b', color: '#6b7280' }
      ]
    }
  },
  {
...
void loop() {
  ...
  delay(1000);
    ...
    circuitData: {
      ...
      wires: [
        { id: 'wire_buzzer_sig', fromComponent: 'arduino', fromPin: 'D8', toComponent: 'buzzer_1', toPin: 'positive', color: '#f97316' },
        { id: 'wire_buzzer_gnd', fromComponent: 'arduino', fromPin: 'GND_D', toComponent: 'buzzer_1', toPin: 'negative', color: '#000000' }
      ]
    }
  },
  {

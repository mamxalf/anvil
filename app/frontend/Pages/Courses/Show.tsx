            ...
            <div className="space-y-4">
              {modules && modules.length > 0 ? (
                modules.map((mod: any, index: number) => (
                  <Card
                    key={mod.id}
                    className="border-l-4 border-l-primary overflow-hidden hover:shadow-md transition-shadow"
                  >
          ...
          <Card className="overflow-hidden shadow-lg border-none">
            ...
            <CardContent className="p-8 space-y-6">
              ...
              {isEnrolled ? (
                ...
                <Button className="w-full text-lg py-6 shadow-xl shadow-primary/20 font-bold hover:scale-105 transition-transform">
                  Enroll Now
                </Button>
              )}
              ...
              {canEdit && (
                <div className="space-y-2">
                  ...
                  <Button
                    variant="secondary"
                    className="w-full font-bold bg-gray-100 hover:bg-gray-200 text-gray-800"
                    asChild
                  >
...
CourseShow.layout = (page: React.ReactNode) => <Layout children={page} />

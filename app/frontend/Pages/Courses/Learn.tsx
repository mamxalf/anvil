...
export default function Learn({ course, modules, currentLesson }: LearnProps) {
  ...
  const handleComplete = () => {
    ...
    router.post(`/courses/${course.id}/course_modules/${currentLesson.module_id}/lessons/${currentLesson.id}/complete`, {}, {
      onSuccess: () => {
        // Trigger confetti
        confetti({
          particleCount: 100,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="h-16 bg-white border-b flex items-center px-4 justify-between shrink-0 z-10">
         <div className="flex items-center gap-4">
           ...
           <Link href="/dashboard" className="font-bold text-xl text-primary font-heading">Kodilearn</Link>
         ...
         <div className="flex items-center gap-4">
            ...
            <Link href="/dashboard" className="text-sm font-medium text-gray-500 hover:text-gray-900">Exit</Link>
         </div>
      </header>
              ...
              {currentLesson ? (
                 <div className="space-y-6">
                    ...
                    <div className="flex justify-between items-center pt-8">
                       ...
                       <Button onClick={handleComplete} size="lg" className="bg-green-600 hover:bg-green-700 text-white font-bold px-8">
                          Complete & Continue
                       </Button>
                    </div>
                 </div>
                 ...
                 <div className="text-center py-20">
                    <h2 className="text-2xl font-bold text-gray-700">Course Completed! (Or No Lessons)</h2>

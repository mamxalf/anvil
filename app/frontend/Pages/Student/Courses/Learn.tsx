...
export default function Learn({ course, modules, currentLesson }: LearnProps) {
  ...
  const handleComplete = () => {
    ...
    router.post(`/student/courses/${course.id}/course_modules/${currentLesson.module_id}/lessons/${currentLesson.id}/complete`, {}, {
      onSuccess: () => {
        confetti({
          particleCount: 100,
          spread: 70,
    ...
    <div className="min-h-screen flex flex-col -m-4 sm:-m-6 lg:-m-8">
      ...
      <header className="h-16 bg-white border-b flex items-center px-4 justify-between shrink-0 z-10">
         <div className="flex items-center gap-4">
           ...
           <Link href="/student/dashboard" className="font-bold text-xl text-kodibot-orange font-heading">Kodilearn</Link>
           <div className="h-6 w-px bg-gray-200 mx-2 hidden md:block" />
           <span className="font-medium text-gray-600 hidden md:block">{course.title}</span>
         </div>
         
         <div className="flex items-center gap-4">
            <Link href="/student/courses" className="flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-kodibot-orange transition-colors">
              ...
              {currentLesson ? (
                 <div className="space-y-6">
                    ...
                    <div className="flex justify-between items-center pt-8">
                       <Button variant="outline" className="rounded-xl font-bold">Previous Lesson</Button>
                       <Button onClick={handleComplete} size="lg" className="bg-kodibot-green hover:bg-kodibot-green/90 text-white font-bold px-8 rounded-xl shadow-lg">
                 ...
                 <div className="text-center py-20 bg-white rounded-2xl">
                    ...
                    <p className="text-gray-500 mt-2">Select a lesson to review or return to dashboard.</p>
                    <Button asChild className="mt-6 bg-kodibot-orange hover:bg-kodibot-orange/90 rounded-xl">

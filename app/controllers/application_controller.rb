  ...
  inertia_share do
    {
      ...
      locale: I18n.locale,
      translations: i18n_translations_for_namespaces(%w[auth auth_kids menu dashboard common courses lessons gamification mascot notifications settings errors quiz maze_game portfolio])
    }
  end
